        ...
        <div className="container mx-auto px-4 max-w-2xl">
          ...
          >
            ...
            <motion.button
              ...
              className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-green-600 text-white rounded-xl font-semibold hover:bg-green-700 transition-colors mb-4"
          ...
          <motion.button
            ...
            disabled={!locationSelected || !callConfirmed}
            className={`w-full btn-gold py-4 text-lg ${
              !locationSelected || !callConfirmed
                ? "opacity-50 cursor-not-allowed"
                : ""
            }`}
            whileHover={locationSelected && callConfirmed ? { scale: 1.02 } : {}}
            whileTap={locationSelected && callConfirmed ? { scale: 0.98 } : {}}
          >
